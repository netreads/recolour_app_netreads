            ...
            <div className="border rounded-lg overflow-hidden bg-card">
              ...
              {openSection === "support" && (
                <nav className="px-4 py-3 space-y-2 bg-accent/50">
                  <Link href="/about" className="block py-2 text-sm text-muted-foreground hover:text-foreground transition-colors">
                    About Us
                  </Link>
          ...
          <div className="grid grid-cols-12 gap-8 lg:gap-12">
            ...
            <div className="col-span-12 lg:col-span-8 grid grid-cols-3 gap-8">
              ...
              <div className="space-y-4">
                ...
                <nav className="flex flex-col space-y-3">
                  <Link href="/about" className="text-sm text-muted-foreground hover:text-foreground hover:translate-x-1 transition-all">
                    About Us
                  </Link>
